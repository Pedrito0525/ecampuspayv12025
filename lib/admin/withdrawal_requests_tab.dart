...
class _WithdrawalRequestsTabState extends State<WithdrawalRequestsTab> {
  ...
  Future<void> _loadWithdrawalRequests() async {
    ...
    try {
      print(
        '🔍 [DEBUG] Loading withdrawal requests - Loading both student and service requests',
      );
      ...
      print(
        '📊 [DEBUG] Student requests - success: ${studentResult['success']}',
      );
      print(
        '📊 [DEBUG] Service requests - success: ${serviceResult['success']}',
      );
      ...
      if (studentResult['success'] == true) {
        ...
        print('📦 [DEBUG] Student requests loaded: ${studentRequests.length}');
      ...
      if (serviceResult['success'] == true) {
        ...
        print('📦 [DEBUG] Service requests loaded: ${serviceRequests.length}');
        ...
        for (var request in serviceRequests) {
          ...
          if (serviceAccountId != null) {
            try {
              ...
              print(
                '⚠️ [DEBUG] Error loading service data for $serviceAccountId: $e',
              );
      ...
      print('📦 [DEBUG] Total requests loaded: ${allRequests.length}');
  ...
  List<Map<String, dynamic>> _getFilteredRequests() {
    ...
    print(
      '🔍 [DEBUG] _getFilteredRequests - Status Filter: $_selectedFilter, Type Filter: $_selectedType, Total: ${_allRequests.length}, Filtered: ${filtered.length}',
    );
