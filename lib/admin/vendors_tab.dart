...
class _VendorsTabState extends State<VendorsTab> {
  ...
  bool _hasAttemptedAnalyticsLoad =
      false; // Track if we've attempted initial load
                          ...
                          : () async {
                            ...
                            if (result['success'] == true) {
                              ...
                              if (mounted) {
                                ...
                                final errorMessage =
                                    _getUserFriendlyMessageFromResponse(
                                      result,
                                    ) ??
  ...
  Future<void> _loadAnalyticsData({bool isInitialLoad = false}) async {
    ...
    const minLoadingDuration = Duration(
      milliseconds: 500,
  ...
  Future<void> _loadScanners() async {
    try {
      ...
      _showErrorDialog(
        'Error loading scanner data: ${_getUserFriendlyError(e)}',
      );
    }
  }
  ...
  Future<void> _unassignScanner(String scannerId) async {
    try {
      ...
      _showErrorDialog(
        'Error unassigning scanner: ${_getUserFriendlyError(e)}',
      );
    }
  }
  ...
  Future<void> _loadMainServices() async {
    ...
    try {
      ...
      _showErrorDialog(
        'Error loading main services: ${_getUserFriendlyError(e)}',
      );
    } finally {
      setState(() {
    ...
    try {
      ...
      if (result['success']) {
        _showSuccessDialog(
          ...
          'The service account must confirm their email before they can sign in.',
        );
        _clearForm();
